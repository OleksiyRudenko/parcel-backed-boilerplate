# Contributing to parcel-backed-boilerplate
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your
   ...
   git clone https://github.com/<your-username>/parcel-backed-boilerplate.git
   # Navigate to the newly cloned directory
   cd parcel-backed-boilerplate
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/OleksiyRudenko/parcel-backed-boilerplate.git
   ```
...
4. Commit your changes in logical chunks. Please adhere to these
   ...
   Be sure to add a test to the `./src/index.html` file if appropriate, and test
...
2. Use a dedicated commit to increment the version. The version needs to be
   added to the CHANGELOG (inc. date), and the `package.json` files.
...
[OleksiyRudenko/default-beauty.css/CONTRIBUTING.md](https://github.com/OleksiyRudenko/default-beauty.css/blob/master/CONTRIBUTING.md)
